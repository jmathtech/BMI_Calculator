...
class BMIIndex(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # Labels
        label_left = customtkinter.CTkLabel(master=frame_left, text="BMI Calculator",
        ...
        self.entry_right_01 = customtkinter.CTkEntry(master=frame_right, width=180, height=30,
                                                     placeholder_text="Your height in Inches",
                                                     font=customtkinter.CTkFont(size=12))
        ...
        self.entry_right_02 = customtkinter.CTkEntry(master=frame_right, width=180, height=30,
                                                     placeholder_text="Your weight in Pounds",
                                                     font=customtkinter.CTkFont(size=12))
    ...
    def bmi_calculate(self):
        try:
            self.height_meters = float(self.height_inches * 0.0254)
            self.weight_kilos = float(self.weight_pounds * 0.453592)
